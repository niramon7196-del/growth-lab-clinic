...
code = code.replace(
  ...
  `<div className={"h-screen w-full overflow-hidden flex app-shell bg-transparent font-sans text-[#1A1A24] relative select-none max-w-[100vw] box-border " + (activeTab !== 'นัดหมาย' ? 'has-main-bg' : '')}>`
);
